...
module.exports = (router) => {
   ...
   * @apiGroup Auth
   * @apiVersion 1.0.0
   * @api {post} /v1/auth/loginWithOtp  Login with Otp
   * @apiDescription Login with Otp
   * @apiParam {String}   accessToken Access token
   * @apiPermission all
   */
  router.post(
    '/v1/auth/loginWithOtp',
...
/**
   * @apiGroup Auth
   * @apiVersion 1.0.0
   * @api {post} /v1/auth/getOtp  get Otp
   * @apiDescription login with One Time Password
   * @apiParam {String}  accessToken Access token
   * @apiPermission all
   */
  router.post(
    ...
    Middleware.Response.success('otp')
  );
...
/**
   * @apiGroup Auth
   * @apiVersion 1.0.0
   * @api {post} /v1/auth/email-exists  check email Exists
   ...
   * @apiGroup Auth
   * @apiVersion 1.0.0
   * @api {post} /v1/auth/autologin  Token login
   * @apiDescription Login with email and Token
   * @apiParam {String}   email      email address
